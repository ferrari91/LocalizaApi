...
namespace Localiza.Data.Functions
{
    ...
    public class Criptografia
    {
        ...
        [Obsolete]
        static public string Descriptografar(string Valor)
        {
            Criptografia crip = new Criptografia(CryptProvider.DES);
            crip.Key = "LocalizaApiCrip";
            return crip.Decrypt(Valor);
        }

        [Obsolete]
        static public string Criptografar(string Valor)
        {
            Criptografia crip = new Criptografia(CryptProvider.DES);
            crip.Key = "LocalizaApiCrip";
            return crip.Encrypt(Valor);
        }
